...
public sealed class Location
{
    ...
    private Location(LocationName name, Address address, IEnumerable<Department> departments)
    {
    ...
    public static Location Create(string name, string country, string city, string street, IEnumerable<Department> departments)
    {
